<template>
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      <!-- Upload Dropbox -->
      <!-- drop 当用户释放被拖拽的文件或者元素的时候，会发出drop事件 -->
      <div
  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); //"music-e9b33.appspot.com"
        const songsRef = storageRef.child(`songs/${file.name}`);
        //"music-e9b33.appspot.com/songs/example.mp3"
        ...
        task.on(
          ...
          (snapshot) => {
            ...
            this.uploads[uploadIndex].current_process = progress;
          },
          (error) => {
